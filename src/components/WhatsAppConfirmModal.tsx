  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Action Buttons */}
        <div className="bg-[#FAF8F5] border-t border-[#EAE5DA] px-4 py-2.5 flex items-center justify-end gap-2">
          <button
            type="button"
            onClick={closeWhatsAppModal}
            className="btn-3d-matte-red px-3.5 py-1.5 text-xs font-semibold"
          >
            বাতিল
          </button>
          <button
            ...
            className="btn-3d-matte-green inline-flex items-center gap-1.5 px-4 py-1.5 text-xs font-bold"
          >
